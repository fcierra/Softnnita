package co.isoft.nnita.profile.controllers;
...
public class AppController
{
	...
	public String newEmployee(ModelMap model) {
        Usuarios employee = new Usuarios();
	...
	public String saveEmployee(@Valid Usuarios employee, BindingResult result,
			ModelMap model) {
	...
	public String updateEmployee(@Valid Usuarios employee, BindingResult result,
